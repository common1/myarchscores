# Generated by Django 5.1.1 on 2025-05-08 12:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('archer', models.ForeignKey(help_text='format: required', on_delete=django.db.models.deletion.PROTECT, related_name='clubmember_archer', to='api.archer', verbose_name='archer who is member')),
                ('club', models.ForeignKey(help_text='format: required', on_delete=django.db.models.deletion.PROTECT, related_name='clubmember_club', to='api.club', verbose_name='club of the member')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='club',
            name='archers',
            field=models.ManyToManyField(blank=True, help_text='format: not required', related_name='clubs', through='api.Membership', to='api.archer'),
        ),
    ]
