# Generated by Django 5.1.1 on 2025-05-31 07:02
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('api', '0008_remove_result_scoringsheet_scoringsheettype_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='result',
            name='scoringsheet',
            field=models.ForeignKey(blank=True, help_text='format: not required', null=True, on_delete=django.db.models.deletion.PROTECT, related_name='result_scoringsheet', to='api.scoringsheet', verbose_name='scoringsheet used'),
        ),
